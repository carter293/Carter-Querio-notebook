...
if TYPE_CHECKING:
    from app.models import Cell, CellStatus, Output
else:
    Cell = 'Cell'
...
def to_mime_bundle(obj: object) -> Optional['Output']:
    ...
    from app.models import Output, MimeType
...
async def execute_sql_cell(cell, conn_string: str, globals_dict: Dict[str, Any]) -> ExecutionResult:
    ...
    """
    from app.models import CellStatus, Output, MimeType
    from app.utils.ast_parser import substitute_sql_variables
