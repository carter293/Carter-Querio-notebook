...
if TYPE_CHECKING:
    from app.models import Notebook, Cell, CellStatus, CellType
    from app.websocket import WebSocketBroadcaster
else:
    Notebook = 'Notebook'
    Cell = 'Cell'
...
class ExecutionScheduler:
    ...
    async def _drain_queue(self, notebook_id: str, notebook, broadcaster):
        ...
        from app.execution.dependencies import topological_sort, get_all_dependents
    ...
    async def _execute_cell(self, notebook_id: str, cell, notebook, broadcaster):
        ...
        from app.execution.executor import execute_python_cell, execute_sql_cell
        from app.models import CellStatus, CellType
